...
class ModalExample extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      projectId:this.props.propContent.projectId
    };
...
handleClick = id => {
  ...
  render() {
      ...
      let fName = propContent.contributors[0] ? propContent.contributors[0].firstName : "";
      let lName = propContent.contributors[0] ? propContent.contributors[0].lastName : "";
      let profilePhoto = propContent.contributors[0] ? propContent.contributors[0].profilePhoto : "profile.png";
    return (
      <div>
        ...
        <Label for="status">Status:</Label>
          ...
          <ModalFooter>
          <img height="35" alt={fName + ' '+ lName } title={fName + ' '+ lName } src={'/assets/img/' + profilePhoto}/>
            <Button color="primary" onClick={()=>this.handleClick(propContent.id)}>Update</Button>
